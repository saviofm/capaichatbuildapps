...
const { DELETE } = cds.ql;
const { storeRetrieveMessagesbuild, storeModelResponse } = require('./memory-helper');
...
const tableName = 'capaichatbuildapps_DOCUMENTCHUNK'; 
...
async function getChatRagResponseChat(MessageTwilio) {
    try {
        ...
        const memoryContext = await storeRetrieveMessagesbuild(conversationId, messageId, message_time, user_id, user_query, Conversation, Message);
