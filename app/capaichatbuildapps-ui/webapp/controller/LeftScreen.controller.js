sap.ui.define([
    ...
    return Controller.extend("capaichatbuildappsui.controller.LeftScreen", {
        ...
        onUploadFileBtnSelect: function(oEvent){
            ...
            this.fileUploadFragment ??= this.loadFragment({
                name: "capaichatbuildappsui.view.FileUploading"
            });
        ...
        onManageFileBtnSelect: function(){
            ...
            this.fileManagementFragment ??= this.loadFragment({
                name: "capaichatbuildappsui.view.FileManagement"
            });
